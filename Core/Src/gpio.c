...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, ENA1_Pin|DIR1_Pin|LED2_R_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DIR2_Pin|ENA2_Pin|STEP2_Pin|ENA3_Pin
                          |STEP4_Pin|RS485_CTR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : I2C_SDA_Pin I2C_SCK_Pin DIPSW2_Pin DIPSW4_Pin
                           DIPSW1_Pin DIPSW8_Pin */
  GPIO_InitStruct.Pin = I2C_SDA_Pin|I2C_SCK_Pin|DIPSW2_Pin|DIPSW4_Pin
                          |DIPSW1_Pin|DIPSW8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
